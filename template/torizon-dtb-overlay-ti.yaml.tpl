...
customization:
  device-tree:
    include-dirs:
      ...
      - linux-toradex/arch/arm64/boot/dts/ti
...
output:
  easy-installer:
    local: build/torizon_${MACHINE}_optologic_panel-cap-touch-${DISPLAY}-lvds_Tezi_7.7.0-devel-202605
